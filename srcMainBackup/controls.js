...
export class Controls {
  constructor() {
    ...
    this.actions = {
      ...
      right: false,
      sprint: false,
      dive: false,  // toggle, not hold
    };

    // Dive is a toggle (press once = dive, press again = surface)
    // We track the event, not held state
    this.onDiveToggle = null;  // callback set by main.js
