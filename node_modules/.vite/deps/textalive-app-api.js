...
function k(t, e2, r2) {
  return !N.test(t) && !t.match(/[（(].+(?:転載|書き起こし).*[）)]/) && (!t.match(/(作詞|作曲).+(作詞|作曲)/) || 0 !== e2 && e2 !== r2.length - 2);
}
function j(t) {
            ...
            return n2.sent(), r2 = (function(t3) {
              return (function(t4) {
                return t4 = (function(t5) {
                  ...
                  for (var e3, r3, n3, i2, o2, s2 = new RegExp("[（(]?(.)繰り返し[)）]?", "g"); null !== (r3 = s2.exec(t5)); ) n3 = r3[1], i2 = new RegExp("^(" + n3 + "[\\s\\S]+?)(?=\\n\\n[^\\u3000|\\s])", "m"), null !== (o2 = t5.match(i2)) && (e3 = o2[1].replace(new RegExp("^" + n3, "m"), "").replace(new RegExp("^\\n"), "").replace(new RegExp("^\\u3000", "mg"), ""), t5 = (t5 = t5.replace(i2, (function() {
                    return e3;
                  }))).replace(new RegExp("[（\\(]?" + n3 + "繰り返し[\\)）]?", "g"), e3).replace(new RegExp("^" + n3, "m"), ""));
                  return t5;
                })(t4 = t4.split(/\n/).filter(k).join("\n")), t4 = (function(t5) {
...
function Pn() {
  return yn(this, 0, void 0, (function() {
    return gn(this, (function(t) {
      return bn && bn.Player ? [2, bn] : "undefined" == typeof window ? [2, import("./main-OTPXDHFT.js")] : window.Songle && window.Songle.Player ? [2, window.Songle] : (mn || (mn = new Promise((function(t2) {
        var e2 = false;
    ...
    return yn(this, 0, void 0, (function() {
      ...
      return gn(this, (function(i2) {
        switch (i2.label) {
          ...
          case 2:
            return this.manager.isBackgroundSpecialImageAsset(t2) ? [2, { css: 'url("https://api.textalive.jp/images/backgrounds/snowmiku2016/' + (n2 = /^snowmiku2016-([0-9]{2})$/.exec(e2))[1] + '.jpg")', contentUrl: "https://api.textalive.jp/images/backgrounds/snowmiku2016/" + n2[1] + ".jpg", url: "https://snowmiku.com/2016/info_chara.html", name: "SNOW MIKU 2016", authorName: "豆の素", originalUrl: e2, x: t2 ? t2.x : void 0, y: t2 ? t2.y : void 0, defaultY: 0 }] : [2, { originalUrl: null, css: "", x: t2 ? t2.x : void 0, y: t2 ? t2.y : void 0 }];
        }
      }));
    }));
      ...
      return yn(r2, 0, void 0, (function() {
        ...
        return gn(this, (function(p2) {
          switch (p2.label) {
            ...
            case 1:
              return "ja" === (null == (o2 = p2.sent()) ? void 0 : o2.lang) ? console.warn("[TextAlive API] 楽曲 アーティスト:", Mi(e3), "/ 楽曲名:", Mi(r3), "/ 配信元サイト:", Mi(n3)) : console.warn("[TextAlive API] Song artist:", Mi(e3), "/ song name:", Mi(r3), "/ distributed at:", Mi(n3)), [2];
          }
        }));
      }));
      ...
      return yn(r2, 0, void 0, (function() {
        ...
        return gn(this, (function(s2) {
          switch (s2.label) {
            ...
            case 1:
              return "ja" === (null == (i3 = s2.sent()) ? void 0 : i3.lang) ? console.warn("[TextAlive API] 歌詞 アーティスト:", Mi(e3), "/ 歌詞名:", Mi(r3), "/ 配信元サイト:", Mi(n3)) : console.warn("[TextAlive API] Song lyrics artist:", Mi(e3), "/ lyrics name:", Mi(r3), "/ distributed at:", Mi(n3)), [2];
          }
        }));
      }));
    }, onDispose: function() {
